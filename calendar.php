     ...
     */
    {
        ...
        if( $kfrAppt && $kfrAppt->Value('fk_clients') ) {
            ...
            $sInvoice = "<form><div class='row'><div class='col-md-6'><span>Name:&nbsp </span> <input type='text' value='%1\$s'></div> <div class='col-md-6'> <span>Send invoice to:&nbsp; </span> <input type='email' value='%2\$s'></div></div>"
                        ...
                        . "<div class='row'><div class='col-md-12'><span>Rate: </span> <input type='text' value='$%6\$d'></div><div class='col-md-6'><span> Session Description:&nbsp </span> <input type='text' value='%7\$s'></div></div><input type='submit' value='Confirm'><input type='submit' value='Confirm and Email' /></form>";
