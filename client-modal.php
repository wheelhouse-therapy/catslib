            ...
            <div class=\"modal-dialog\">
             ...
             foreach ($pro_roles_name as $k => $role){
                 if($k == "Other"){
                     ...
                     .SEEDCore_ArrayExpandRows($oPeopleDB->KFRel("PE")->GetRecordSetRA("pro_role NOT IN (".SEEDCore_ArrayExpandSeries($otherless, ",'[[]]'",TRUE,array("sTemplateFirst"=>"'[[]]'")).")"), "<option value='[[_key]]' />[[pro_first_name]] [[pro_last_name]] ([[pro_role]])")
                     ."</select><br />";
                 }else {
                     $s .= "$role <select name='$k'><option selected value='0'>Select Provider"
